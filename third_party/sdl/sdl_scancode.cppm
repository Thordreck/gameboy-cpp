...
export module sdl:scancode;
export import std;

namespace sdl
{
    export using scancode_t = std::uint16_t;
    export constexpr scancode_t num_scancodes = SDL_SCANCODE_COUNT;

    export enum class scancode : scancode_t
    {
        ...
        non_us_backlash = SDL_SCANCODE_NONUSBACKSLASH,
        ...
        thousand_separator = SDL_SCANCODE_THOUSANDSSEPARATOR,
        ...
        keypad_dbl_ampersand = SDL_SCANCODE_KP_DBLAMPERSAND,
        keypad_vertical_bar = SDL_SCANCODE_KP_VERTICALBAR,
        keypad_dbl_vertical_bar = SDL_SCANCODE_KP_DBLVERTICALBAR,
        ...
        app_control_new = SDL_SCANCODE_AC_NEW,
        app_control_open = SDL_SCANCODE_AC_OPEN,
        app_control_close = SDL_SCANCODE_AC_CLOSE,
        app_control_exit = SDL_SCANCODE_AC_EXIT,
        app_control_save = SDL_SCANCODE_AC_SAVE,
        app_control_print = SDL_SCANCODE_AC_PRINT,
        app_control_properties = SDL_SCANCODE_AC_PROPERTIES,
        app_control_search = SDL_SCANCODE_AC_SEARCH,
        app_control_home = SDL_SCANCODE_AC_HOME,
        app_control_back = SDL_SCANCODE_AC_BACK,
        app_control_forward = SDL_SCANCODE_AC_FORWARD,
        app_control_stop = SDL_SCANCODE_AC_STOP,
        app_control_refresh = SDL_SCANCODE_AC_REFRESH,
        app_control_bookmarks = SDL_SCANCODE_AC_BOOKMARKS,
