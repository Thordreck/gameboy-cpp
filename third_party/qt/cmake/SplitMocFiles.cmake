...
set(SPLIT_SCRIPT "${CMAKE_CURRENT_SOURCE_DIR}/cmake/SplitSingleMocImpl.cmake" PARENT_SCOPE)

function(split_moc_files)
  # Parse arguments
  set(options "")
  set(oneValueArgs TARGET SOURCE_EXTENSION)
  ...
  # Set default source extension if not provided
  if(NOT ARG_SOURCE_EXTENSION)
    set(ARG_SOURCE_EXTENSION ".cppm")
  endif()
  ...
  foreach(MOC_BASE ${ARG_MOC_SOURCE_FILES})
    set(MOC_FILE "${AUTOGEN_DIR}/${MOC_BASE}.moc")
    set(STAMP_FILE "${BINARY_DIR}/.moc_split_${MOC_BASE}.stamp")
    ...
    add_custom_command(
      ...
      DEPENDS ${SOURCE_DIR}/${MOC_BASE}${ARG_SOURCE_EXTENSION}
      COMMENT "Splitting ${MOC_BASE}.moc")

    list(APPEND MOC_SPLIT_OUTPUTS ${STAMP_FILE})

    # Set source file dependency on stamp file
    set_source_files_properties(${SOURCE_DIR}/${MOC_BASE}${ARG_SOURCE_EXTENSION}
                                PROPERTIES OBJECT_DEPENDS ${STAMP_FILE})
  endforeach()

  # Create a custom target that depends on all split stamp files
